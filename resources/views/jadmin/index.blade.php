        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    ...
                    <a href="{{url('jadmin/category/edit' , $cat->id)}}" style="color: green"> {{$cat->products->count()}} Items </a>
                    </div>
                    <a href="{{url('jadmin/category/edit' , $cat->id)}}">  <div class="h5 mb-0 font-weight-bold text-gray-800">{{$cat->name}}</div></a>
                </div>
                <div class="col-auto">
