...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
    ...
    @foreach ($products as $p)
        <tr>
            ...
            <td>
                <a href="{{url('admin/products/edit' , $p->id)}}" class="btn btn-success btn-icon-split">
    ...
    <a href="{{url('admin/products/create')}}" class="btn btn-success btn-icon-split">
        <span class="icon text-white-50">
            <i class="fas fa-check"></i>
        </span>
        <span class="text">Create a product </span>
    </a>
@endsection
