...
<form action="{{url('admin/products/update' , $product->id )}}" method="POST" style="width: 100%">
    @csrf
    @method('POST')
    <div class="col-sm-6">
        <input type="text" name="product_name" class="form-control form-control-user" id="exampleLastName"
    ...
    <div class="col-sm-6">
        <input type="text" disabled name="product_category" class="form-control form-control-user" id="exampleLastName"
            placeholder="Product Name" value="{{$product->category->name}}">
    </div>
