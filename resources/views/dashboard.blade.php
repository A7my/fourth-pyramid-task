        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    ...
                    <a href="{{route('category.show' , $cat->id)}}" style="color: green"> {{$cat->products->count()}} Items </a>
                    </div>
                    <a href="{{route('category.show' , $cat->id)}}">  <div class="h5 mb-0 font-weight-bold text-gray-800">{{$cat->name}}</div></a>
                </div>
                <div class="col-auto">
