...
<form action="{{url('admin/adminUser/store')}}" method="POST">
    @csrf
    @method('POST')
    <div class="col-sm-6">
        <input style="width: 600px" name="name" type="text" class="form-control form-control-user" id="exampleLastName" placeholder="Name">
        <input style="width: 600px" name="email" type="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Email Address">
        <input style="width: 600px" name="password" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password">
    <select style="width: 600px" name="role" id="" class="form-control form-control-user">
